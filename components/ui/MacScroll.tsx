...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 1], [0, isMobile ? 1300 : 1200]);
  const rotate = useTransform(scrollYProgress, [0.1, 0.12, 0.3], [-28, -28, 0]);
  const textTransform = useTransform(scrollYProgress, [0, 1.3], [0, 100]);
  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="dark:text-white text-neutral-800 md:text-3xl text-5xl font-bold mb-20 text-center"
      >
        {title}
      </motion.h2>
      {/* Lid */}
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
        ...
        >    
            {theme === "dark" ? (
              <img src="/LOGO.png" className="w-24"/>
                ...
                <img src="/logoLight.png" className="w-24"/>
              )
            }
      ...
      >+
        <iframe src="https://onemusix.vercel.app/" className="rounded-2xl w-[1280px] h-[960px] scale-[0.4] absolute -left-3/4 -top-3/4"/>
      </motion.div>
    </div>
  );
};
...
export const KBtn = ({
  ...
  return (
    <div
      className={cn(
        "p-[0.5px] rounded-[4px]",
        backlit && "bg-white/[0.2] shadow-xl shadow-red-500"
      )}
    >
      <div
        className={cn(
